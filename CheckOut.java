...
public class CheckOut extends JFrame implements ActionListener {
    ...
    ImageIcon il = new ImageIcon(ClassLoader.getSystemResource("canteen/management/system/icons/tick.png"));
    ...
    ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("canteen/management/system/icons/food-picky-logo.PNG"));
    Image i5 = i4.getImage().getScaledInstance(400, 50, Image.SCALE_DEFAULT);
   ...
   getContentPane().setBackground(Color.WHITE);     
    ...
    public void actionPerformed (ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            String table_number = t1.getText();
            
            String str = "update addtables set available = 'Available' where table_number='"+table_number+"'";
            conn c = new conn();
            try{
